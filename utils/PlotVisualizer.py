...
class PlotVisualizer:
    ...
    def plot_with_scatter_cbg_80th_mask(self, data, x_column, y_column,
                                        title='Plot', xlabel='X-Axis', ylabel='Y-Axis',
                                        line_color='blue', scatter_color='red', scatter_marker='x',
                                        ylim=None, alpha=0.8, grid=True):
        """
        Function to plot data with a line and overlay scatter plot for missing data based on 'cbg_80th_mask'.
        ...
        # Plot the main data as a line plot
        plt.plot(data[x_column], data[y_column], color='gray', label=f'{y_column} Masked (Present)', alpha=alpha)

        # Plot the masked data as a line plot overlapping 
        plt.plot(data[x_column], data['cbg_80th_mask'], color=line_color, label=f'cb_80th Unmasked (Present)', alpha=alpha)
